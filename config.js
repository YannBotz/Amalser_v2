...
module.exports = {
    VERSION: 'v7.3.6',
    CHANNEL: 'https://www.instagram.com/janitha129?r=nametag',
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Janiya' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '94703767171@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ 「 ᴊᴀɴɪʏᴀツ 」 ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    ...
    YAK: process.env.YAK === undefined ? '94703767171,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
    ...
    SUPPORT: "94703767171-1612300121",
