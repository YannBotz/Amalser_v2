...
const array = ['🙂','❤','Gn','Night ','night','Morning','Hmm','Gm','Janiyo','Janiya','caption','alive','Di','Bro','jani','avan','converting','mk','Allah','bg','help','Hii','odiko','oho','killadi','oo','Fuck','invite','photo','Hi','love','Owner','Group','list','man','Nanba','Oi','oii','poda','yo','sad','work','set','remove','thukum','poko','myre,','kundan','xmedia','commands','Boss','vava','Myre','Lalitha','start','Adithhari','sing','Hello','Bye','warn','Baby','who','find','power','myr','vanam']
array.map( async (a) => {
