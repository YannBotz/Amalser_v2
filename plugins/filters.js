...
Asena.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
        ...
        if (!!message.mention && message.mention[0] == '94703767171@s.whatsapp.net') {
...
const array = ['yt','xmedia','whatsapp','chat','harry','Ela','Mmm','xxx','Porn','Adarei','bot','Bot','hack','Gn','Night ','night','Morning','Hmm','Gm','Janiyo','Janiya','caption','alive','Di','Bro','jani','avan','converting','mk','white444','bg','love','help','Hii','odiko','oho','killadi','oo','Fuck','invite','photo','Hi','Love','Owner','Group','list','man','Nanba','Oi','oii','poda','yo','sad','work','set','remove','thukum','poko','myre,','kundan','commands','Boss','Myre','Lalitha','start','Adithhari','Hello','Bye','warn','Baby','who','find','power','myr','vanam','Living','sex','huththa','huththi','Kohomada','sexy','free fire','Free Fir','lost','ok','hari']
array.map( async (a) => {
...
const array = ['Jani','escape','truth','nice','let','get','img','Hello','list','hm','Fuck','pottan','update','menu','oh','alive','sad','yt','photo','nokk','nude','oo','myr','kali','Remove','run','bot','Erorr','lost','podey','copy','hi','come','sex','sed','sorry','not','podi','nee','done','oru','kalam','ser','Dey']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
   await message.client.sendMessage(message.jid, fs.readFileSync('./Amalser/' + a + '.webp'), MessageType.sticker, { mimetype: Mimetype.webp, ptt: true,quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(message.jid ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": Config.BOT + '\n', "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./photo/amalser.png')}}}});
}
});
}
