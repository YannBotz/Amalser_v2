...
const array = ['Adarei','bot','Bot','hack','Gn','Night ','night','Morning','Hmm','Gm','Janiyo','Janiya','caption','alive','Di','Bro','jani','avan','converting','mk','Allah','bg','love','help','Hii','odiko','oho','killadi','oo','Fuck','invite','photo','Hi','Love','Owner','Group','list','man','Nanba','Oi','oii','poda','yo','sad','work','set','remove','thukum','poko','myre,','kundan','xmedia','commands','Boss','Myre','Lalitha','start','Adithhari','Hello','Bye','warn','Baby','who','find','power','myr','vanam','Living','sex','huththa','huththi','Kohomada','sexy','වයස','හයි','හුත්තො','ok','hari']
array.map( async (a) => {
...
const array = ['https','sir','Jani','escape','truth','nice','let','get','img','Hello','list','hm','Fuck','pottan','update','menu','oh','alive','sad','yt','photo','nokk','nude','oo','myr','kali','Remove','run','bot','Erorr','lost','podey','copy','hi','come','sex','sed','help','sorry','not','podi','nee','done','oru','kalam','ser','Dey']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
