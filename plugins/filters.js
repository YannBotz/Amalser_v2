...
const array = ['Ela','Mmm','xxx','Porn','Adarei','bot','Bot','hack','Gn','Night ','night','Morning','Hmm','Gm','Janiyo','Janiya','caption','alive','Di','Bro','jani','avan','converting','mk','white444','bg','love','help','Hii','odiko','oho','killadi','oo','Fuck','invite','photo','Hi','Love','Owner','Group','list','man','Nanba','Oi','oii','poda','yo','sad','work','set','remove','thukum','poko','myre,','kundan','xmedia','commands','Boss','Myre','Lalitha','start','Adithhari','Hello','Bye','warn','Baby','who','find','power','myr','vanam','Living','sex','huththa','huththi','Kohomada','sexy','free fire','Free Fir','lost','ok','hari','Whatsapp']
array.map( async (a) => {
