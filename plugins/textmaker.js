        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/pornhub.jpg', async() => {                          
                  ...
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/pornhub.jpg'), MessageType.image, { caption: Config.ALL})
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/frame.jpg', async() => {                          
                  ...
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/frame.jpg'), MessageType.image, { caption: Config.ALL})
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/wall.jpg', async() => {                          
                  ...
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/wall.jpg'), MessageType.image, { caption: Config.ALL})
