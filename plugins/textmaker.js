        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/frame.jpg', async() => {                          
                  ...
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/frame.jpg'), MessageType.image, { caption: Config.AFN })
